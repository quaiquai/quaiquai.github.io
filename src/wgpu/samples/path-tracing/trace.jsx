...
import { getCameraPos, onMouseDown, onMouseMove, onMouseUp, target, up, addCameraEvents } from "../../camera.js"
...
export default function PathTraceSphere() {
    ...
    useEffect(() => { initializeWebGPU(); }, [initializeWebGPU]);
